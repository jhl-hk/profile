...
<div class="max-w-4xl mx-auto backdrop-blur-md rounded-2xl border border-white/20 shadow-2xl relative overflow-hidden {className}"
  ...
  <!-- Content container -->
  <div class="relative z-10 p-8 md:p-8 sm:p-6">
    <slot />
  </div>
</div> 